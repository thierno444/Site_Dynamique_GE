...
<head>
    <meta charset="UTF-8">
    <title>Liste des Étudiants par Ordre de Mérite - Master 1</title>
    <link rel="stylesheet" href="lister_etudiants_merite.css">
</head>
<body>
    <div class="container">
        <h1>Liste des Étudiants par Ordre de Mérite - Master 1</h1>
        <table>
            <thead>
                <tr>
                    <th>Nom</th>
        ...
        <div class="buttons">
            <a href="master1.php" class="button">Retour à la liste des étudiants Master 1</a>
