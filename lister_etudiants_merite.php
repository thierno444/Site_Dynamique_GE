...
$sql = "SELECT e.nom, e.prenom, e.matricule, n.moyenne
        FROM etudiants e
...
<head>
    <meta charset="UTF-8">
    <title>Liste des Étudiants par Ordre de Mérite - Licence 1</title>
    <link rel="stylesheet" href="lister_etudiants_merite.css">
</head>
<body>
    <div class="container">
        <h1>Liste des Étudiants par Ordre de Mérite - Licence 1</h1>
        <table>
            <thead>
                <tr>
                    <th>Matricule</th>
        ...
        <div class="buttons">
            <a href="licence1.php" class="button">Retour à la liste des étudiants Licence 1</a>
